...
A file will automatically generate with the first story comic, but all it needs in the file to start is the desired comic number and URL.

1 https://www.egscomics.com/comic/2002-01-21
